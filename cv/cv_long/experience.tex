...
\vspace{0.1cm}
   \cvitem{}{Pioneered the use of calorimetry timing information to search for hadronic decays of neutral long-lived particles. This lead to the first published search for BSM physics with the full Run 2 dataset from the CMS experiment.}
\vspace{0.1cm}
...
\vspace{0.1cm}
\cvitem{}{ Studied the decay times of long-lived supersymmetric taus as part of a proposal for a new search}
\vspace{0.1cm}
