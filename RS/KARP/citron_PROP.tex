...
leads to the existance of dark particles with a small electric charge, a ``millicharge''.
...
I outline a detailed motivation and design for a new millicharge particle detector, the 
``phase-1 milliQan detector'', with a budget of less than \$50k, that can achieve a dramatic extension 
in sensitivity to millicharge particles, potentially uncovering the link
